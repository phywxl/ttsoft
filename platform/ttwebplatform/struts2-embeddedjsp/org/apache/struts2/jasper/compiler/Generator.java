...
class Generator {
    ...
    private void generateInit() {
        ...
        /* phywxl 20130704 comment. 在tomcat 7中无此类了  */
    ...
    class GenerateVisitor extends Node.Visitor {
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
           ...
           out.printin(
            ...
            //out.println(", " + isFlush + ");");
            /* phywxl 20130704 modify. BEGIN. 注意：注释了上面1条语句 */
            out.println(", out, " + isFlush + ");");  //jsp:include使用同一个输出流， 解决jsp:include指令输出时被包含的文件先输出，主文件后输出的问题
            /* phywxl 20130704 modify. END */
