...
public final class JspRuntimeContext {
    ...
    public JspRuntimeContext(ServletContext context, Options options) {
        ...
        /* phywxl 20130705 add. BEGIN. 注意：注释了上面代码 */
        ClassLoader clr = Thread.currentThread().getContextClassLoader();
        //System.out.println("====JspRuntimeContext.JspRuntimeContext(...) clr=" + clr);
        if (clr instanceof URLClassLoader)
        	parentClassLoader =
            	(URLClassLoader)clr;
        else
        	parentClassLoader = new URLClassLoader(new URL[]{}, clr);
        if (parentClassLoader == null) {
        	clr = this.getClass().getClassLoader();
        	 if (clr instanceof URLClassLoader)
             	...
             	parentClassLoader = new URLClassLoader(null, clr);
        }
        /* phywxl 20130705 add. END */
