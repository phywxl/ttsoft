...
public class JspCompilationContext {
    ...
    public JspCompilationContext(String jspUri,
        ...
        /* wangxianliang 201308201136. 判断空串代码 */
    ...
    public java.io.InputStream getResourceAsStream(String res) {
        ...
        try {
        	//System.out.println("====JspCompilationContext.getResourceAsStream(String) res=" + res);
        	//System.out.println("====JspCompilationContext.getResourceAsStream(String) classLoaderInterface=" + classLoaderInterface);
        	in = classLoaderInterface.getResourceAsStream(canonicalURI(StringUtils.removeStart(res, "/")));
        	/*if (in == null) {
        		Bundle bundle = DefaultBundleAccessor.getInstance().getCurrentBundle();
        		if (bundle != null) {
	        		URL url = bundle.getResource(res);
	        		if (url != null)
    ...
    protected String getDerivedPackageName() {
        if (derivedPackageName == null) {
            ...
            derivedPackageName = (iSep > 0) ?
                    ...
                    //JspUtil.makeJavaPackage(jspUri.substring(1,iSep)) : "";  /* phywxl 20130704 comment. 缺少了第一个字符*/
        }
