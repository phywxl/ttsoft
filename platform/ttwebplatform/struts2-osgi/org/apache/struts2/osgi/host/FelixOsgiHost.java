...
public class FelixOsgiHost extends BaseOsgiHost {
    ...
    protected void startFelix() {
        ...
        try {
	        String metadatapath = this.servletContext.getRealPath("/.metadata/");
        ...
        /* phywxl modify 20130703, ����Http Bridge֧�� �� BEGIN */
        addBridgeOSGiSupport();
        /* phywxl modify 20130703, ����Http Bridge֧�� �� END */
    ...
    /* phywxl modify 20130703, ����Http Bridge֧�� �� BEGIN */
    protected void addBridgeOSGiSupport() {
        try {
            servletContext.setAttribute(BundleContext.class.getName(), felix.getBundleContext());
        } catch (Exception e) {
            if (LOG.isErrorEnabled()) {
                LOG.error("The API of Bridge OSGi has changed and the field [#0] is no longer available. The OSGi plugin needs to be updated", e,
                        "http proxy ServletContext[\"org.osgi.framework.BundleContext\"]");
            }
        }
    }
    /* phywxl modify 20130703, ����Http Bridge֧�� �� END */
